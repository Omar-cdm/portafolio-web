...
export function header() {
    return `
        <header class="w-5/6 h-14 bg-white/2 backdrop-blur-sm sticky z-1 top-1 inset-x-1/12 flex justify-between items-center border-x-1 border-y-1 border-green-400 border-b-green-dark rounded-tl-xl rounded-br-xl px-4 py-2 header">
    ...
    return `
            <div class="w-full h-svh flex flex-col justify-center items-center gap-12 sm:col-span-2 sm:flex-row hero__container">
                ...
                <div class="bg-white/2 backdrop-blur-sm flex flex-col p-4 border-y-2 border-green-400 rounded-tl-xl rounded-br-xl relative sm:w-1/2 hero__content">
                    ...
                    <button class="text-sm text-black-bluish font-semibold absolute bottom-0 right-8 bg-green-400 rounded-t-xl px-4 py-1 hero__button--click">Proyectos</button>
                </div>
            </div>
    `;
};
...
export function elementSkill(img) {
    return `
        <div class="size-18 rounded-full grid place-items-center relative overflow-hidden">
            <div class="absolute bg-hacker-border inset-[-50%] animate-hacker-spin flex justify-center items-center skill">
            </div>
            <div class="size-16 bg-black-bluish rounded-full relative z-1 rotate-none grid place-items-center skill__bar">
                <img src="${img}" class="size-10"/>
            </div>
        </div>
    `;
}
...
function elementArticle(title, description, img, demo, codigo) {
    return `
        <article class="w-5/6 p-2 bg-white/2 backdrop-blur-sm border-1 border-b-2 border-green-400 rounded-xl project">
            ...
            <div class="w-full grid place-items-center mt-4 project__container-image"><img class="w-4/5 project__image" src="${img}"></div>
...
export function elementFormContact() {
    return `
        <form class="w-5/6 flex bg-white/2 backdrop-blur-sm flex-col gap-2 p-4 rounded-md relative sm:w-3/5 contact__form" action="https://formspree.io/f/mvzpbarl" method="POST">
            ...
            <input class="w-3/4 border-1 border-green-400 rounded-sm form__input-email" type="email" name="email" id="email" autocomplete="on" required></input>
            <label class="form__text-message" for="message">Mensaje</label>
            <textarea class="3/5 border-1 border-green-400 rounded-sm form__input-message" name="mensaje" id="message" rows="5" required></textarea>
            <div class="mt-4 flex justify-end px-2 form__button-container">
                <button class="text-sm w-20 border-1 border-b-4 border-r-4 border-green-400 border form__button" type="submit">Enviar</button>
            </div>
...
//<div class="w-full h-2 fixed bg-black-bluish border-b-2 border-green-400 rounded-xs"></div>
